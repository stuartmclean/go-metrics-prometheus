...
func TestPrometheusHistogramGetUpdated(t *testing.T) {
	...
	expected := `name:"test_subsys_histogram" help:"histogram" type:HISTOGRAM metric:<histogram:<sample_count:0 sample_sum:0 bucket:<cumulative_count:0 upper_bound:0.05 > bucket:<cumulative_count:0 upper_bound:0.1 > bucket:<cumulative_count:0 upper_bound:0.25 > bucket:<cumulative_count:0 upper_bound:0.5 > bucket:<cumulative_count:0 upper_bound:0.75 > bucket:<cumulative_count:0 upper_bound:0.9 > bucket:<cumulative_count:0 upper_bound:0.95 > bucket:<cumulative_count:0 upper_bound:0.99 > > > `
	if serialized != expected {
